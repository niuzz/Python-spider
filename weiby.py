...
headers = {
    ...
    'X-Tingyun-Id': 'y5zrBHz_BzQ;r=350275479',
}
...
def get_list_item(list):
    for m in list:
        ...
        obj['fans'] = str(item['followers_count']).split('万')[0]
        try:
            item['reference_price']['multi_top']
        except:
            obj['headline_price'] = ''
            obj['not_headline_price'] = ''
        else:
...
def get_list():
    for i in range(194, 1528):
        print('================   ' + str(i) + '   =====================')
        page = i * 20
        payload = {
            'web_csrf_token': '5b8393705b191',
...
def get_category():
    ...
    headers = {
        'Accept': '*/*',
        'Cookie': 'Hm_lvt_29d7c655e7d1db886d67d7b9b3846aca=1535093227; Hm_lvt_b96f95878b55be2cf49fb3c099aea393=1535093227; _gscu_867320846=35093227ewx2rx38; _gscbrs_867320846=1; loginHistoryRecorded=0; TY_SESSION_ID=029480d3-77c7-48af-b0f0-0edf2d45623c; TRACK_USER_ID=461225; TRACK_DETECTED=1.0.1; TRACK_BROWSER_ID=fba350e3683cfa9f188aad89a0cfd5ea; sensorsdata2015jssdkcross=%7B%22distinct_id%22%3A%22461225%22%2C%22%24device_id%22%3A%221656aaff9d460-056137705612f9-34677908-1296000-1656aaff9d5255%22%2C%22props%22%3A%7B%22%24latest_traffic_source_type%22%3A%22%E7%9B%B4%E6%8E%A5%E6%B5%81%E9%87%8F%22%2C%22%24latest_referrer%22%3A%22%22%2C%22%24latest_referrer_host%22%3A%22%22%2C%22%24latest_search_keyword%22%3A%22%E6%9C%AA%E5%8F%96%E5%88%B0%E5%80%BC_%E7%9B%B4%E6%8E%A5%E6%89%93%E5%BC%80%22%7D%2C%22first_id%22%3A%221656aaff9d460-056137705612f9-34677908-1296000-1656aaff9d5255%22%7D; Hm_lpvt_29d7c655e7d1db886d67d7b9b3846aca=1535201484; Hm_lpvt_b96f95878b55be2cf49fb3c099aea393=1535201485; Hm_lvt_5ff3a7941ce54a1ba102742f48f181ab=1535093500,1535201562; username=; rememberusername=; PHPSESSID=970qih4h2o5ddt9ua36cp1kp13; aLastLoginTime=1535347862; TRACK_IDENTIFY_AT=2018-08-27T05%3A31%3A35.734Z; TRACK_SESSION_ID=268b156fbae77240aa78c95671927ba2; Hm_lpvt_5ff3a7941ce54a1ba102742f48f181ab=1535347915; _gscs_867320846=t35345680ci669s20|pv:8',
        'Host': 'chuanbo.weiboyi.com',
